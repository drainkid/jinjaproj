...
def create_pict(x, y):
 ...
 plt.savefig("jynja_prac/pict.jpg")
...
f_template = open('jynja_prac/function_template.html','r', encoding ='utf-8-sig')
...
f = open('jynja_prac/function.html', 'w', encoding ='utf-8-sig')
